...
namespace TempestGadgets.Executables
{
    public class EOSRootKitExe : Pathfinder.Executable.BaseExecutable
    {
        ...
        public override void LoadContent()
        {
            ...
            {
                bodyText = File.ReadAllText(rootkitDumpPath).Split(Hacknet.Utils.newlineDelim);
            }
            else
            {
        ...
        {
            spriteBatch.Draw(Hacknet.Utils.gradient, dest, os.highlightColor * 0.2f);
        }
        ...
        public override void Completed()
        {
            ...
            comp.GetPortState("eos").SetCracked(true, os.thisComputer.ip);
            ...
            if (comp.adminPass != "alpine")
            {
                ...
                os.delayer.Post(ActionDelayer.Wait(60f), () =>
                {
                    ...
                    comp.GetPortState("eos").SetCracked(false, os.thisComputer.ip);
