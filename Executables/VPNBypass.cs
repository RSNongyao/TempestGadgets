...
public class VPNBypass : Pathfinder.Executable.BaseExecutable
{
    ...
    public VPNBypass(Rectangle location, OS operatingSystem, string[] args) : base(location, operatingSystem, args)
    {
        ramCost = 360;
    ...
    public override void Draw(float t)
    {
        ...
        Vector2 scale = new Vector2(pointRatio / (float)VPNBypass.point.Width);
    ...
    public override void Update(float t)
    {
        if (lifetime >= crackTime && isExiting == false && !VPNPortOpened)
        {
            ...
            Programs.getComputer(os, targetIP).openPort(VPNPort, os.thisComputer.ip);
